package com.gi2t.face.detect.camera.preview;
...
public class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		CameraInterface.getInstance().doOpenCamera(null, CameraInfo.CAMERA_FACING_FRONT);//CAMERA_FACING_BACK CAMERA_FACING_FRONT
	}
